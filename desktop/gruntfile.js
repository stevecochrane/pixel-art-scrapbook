module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        compass: {
            ...
            dist: {
                options: {
                    sassPath: 'src/sass/',
                    cssPath: 'build/Resources/css/',
                    imagesPath: 'build/Resources/img/',
                    javascriptsPath: 'build/Resources/js/',
        ...
        concat: {
            ...
            dist: {
                ...
                src: [
                    ...
                    'src/js/libs/handlebars-1.0.0.js',
                    'src/js/libs/ember-1.0.0.js',
                    'src/js/app.js'
                ],
                //  The location of the resulting JS file.
                dest: 'build/Resources/js/<%= pkg.name %>.js'
            }
        },
        ...
        uglify: {
            ...
            dist: {
                files: {
                    ...
                    'build/Resources/js/<%= pkg.name %>.min.js': ['<%= concat.dist.dest %>']
                }
            }
        },
    ...
    grunt.registerTask('js', ['htmlmin', 'jshint', 'concat', 'uglify']);
    grunt.registerTask('css', ['htmlmin', 'compass']);
